...
export function catmullRom2bezier(points: { x: number; y: number }[]): Array<{ start: { x: number; y: number }; cp1: { x: number; y: number }; cp2: { x: number; y: number }; end: { x: number; y: number } }> {
...
export function simplifyDouglasPeucker(points: { x: number; y: number }[], epsilon: number): { x: number; y: number }[] {
